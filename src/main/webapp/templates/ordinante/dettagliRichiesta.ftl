...
<div class=" p-6 rounded-xl shadow-normalBox mt-8">
    ...
    <div class="mt-6">
        <a href="/admin/richieste" class="rounded-full bg-verde font-semibold text-white text-lg px-4 py-2 shadow-buttonBox hover:shadow-buttonBoxHover">Torna alla lista</a>
    </div>
</div>