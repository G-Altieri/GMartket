...
<div class="flex flex-col items-center mt-12">  <!-- Centrato orizzontalmente, ma verso l'alto -->
    ...
    <form action="/ordinante/invia-richiesta" method="POST" class="max-w-lg w-full">
...
<#--                <li class="flex items-center justify-between bg-white shadow rounded-lg p-4 rounded-2xl bg-light border border-bluScuro">-->
                <li class="flex flex-row items-center justify-between gap-4 bg-white shadow rounded-lg p-4 rounded-2xl bg-light border border-bluScuro">
                    ...
                    <input type="text" name="caratteristica_${caratteristica.key}" class="border border-gray-300 rounded-md px-4 py-2 flex-1" placeholder="Inserisci valore">
            ...
            <li class="flex flex-row items-center justify-between gap-4 bg-white shadow rounded-lg p-4 rounded-2xl bg-light border border-bluScuro">
                <h2 class="text-xl font-semibold ">Vuoi Aggiungere delle note?</h2>
                <input type="text" name="note" class="border border-gray-300 rounded-md px-4 py-2 flex-1" placeholder="Inserisci nota">
