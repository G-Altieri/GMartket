...
package it.univaq.gmartket.framework.result;
/*
 * TemplateResult.java
 *
...
//some useful information
    protected Map getDefaultDataModel(HttpServletRequest request) {
        ...
        default_data_model.put("includeHeader", "true"); //imposto il header di default
        default_data_model.put("includeFooter", "true"); //imposto il footer di default
