...
--
-- Host: 127.0.0.1
-- Creato il: Ott 29, 2024 alle 19:30
...
INSERT INTO `notifica` (`id`, `version`, `titolo`, `contenuto`, `letta`, `id_utente`, `richiesta`, `proposta`, `ordine`, `ruolo`) VALUES
(4, 1, 'Nuova Richiesta', 'Richiesta di GiovanniO Rossi categoria: Smartphone', 1, NULL, 37, NULL, NULL, 'TECNICO'),
(5, 1, 'La tua richiesta é stata presa in carico!!!', 'La richiesta richiesta #2ZRPI é stata presa in carico da: GiovanniT Rossi', 0, 1, 37, NULL, NULL, NULL);
...
(37, '2ZRPI', 1, 2, 5, 'testNotifica', 'ASSEGNATO', '2024-10-28 20:33:22', NULL, 2);
